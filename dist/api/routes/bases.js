...
// Validation schemas
const createBaseSchema = zod_1.z.object({
    baseId: zod_1.z.string().min(1),
    name: zod_1.z.string().min(1),
    apiKey: zod_1.z.string().min(1),
    rateLimitRpm: zod_1.z.number().int().positive().optional(),
    recordLimit: zod_1.z.number().int().positive().optional(),
    storageLimit: zod_1.z.number().int().positive().optional()
});
const updateBaseSchema = zod_1.z.object({
...
router.post('/', async (req, res, next) => {
    try {
        ...
        logger_1.logger.info('Base registered:', { baseId: base.baseId, name: base.name });
...
router.put('/:baseId', async (req, res, next) => {
    try {
        ...
        logger_1.logger.info('Base updated:', { baseId, updatedFields: Object.keys(validatedData) });
        return res.json({
...
router.delete('/:baseId', async (req, res, next) => {
    try {
        ...
        logger_1.logger.info('Base deleted:', { baseId });
        return res.json({
